...
(15, (now()::timestamp::date + interval'15 day' + interval'21 hours')::timestamp, (now()::timestamp::date + interval'16 day' + interval'1.5 hours')::timestamp, 8),
(16, (now()::timestamp::date + interval'16 day' + interval'21 hours')::timestamp, (now()::timestamp::date + interval'17 day' + interval'1.5 hours')::timestamp, 8),
(17, (now()::timestamp::date + interval'17 day' + interval'21 hours')::timestamp, (now()::timestamp::date + interval'18 day' + interval'1.5 hours')::timestamp, 8),
(18, (now()::timestamp::date + interval'18 day' + interval'21 hours')::timestamp, (now()::timestamp::date + interval'19 day' + interval'1.5 hours')::timestamp, 8),
(19, (now()::timestamp::date + interval'19 day' + interval'21 hours')::timestamp, (now()::timestamp::date + interval'20 day' + interval'1.5 hours')::timestamp, 8),
(20, (now()::timestamp::date + interval'20 day' + interval'21 hours')::timestamp, (now()::timestamp::date + interval'21 day' + interval'1.5 hours')::timestamp, 8);
